...
Once the filtering set up is complete, click 'Apply'</p>
        <img src="/images/download1.png" alt="Date Filtering Example" class="w-full xl:max-2xl:w-[50%] sm:w-[50%] h-full rounded-md mt-4"/>
    ...
    },
    {
      ...
      answer: `
        ...
        <img src="/images/download2.png" alt="Date Filtering Example" class="w-full xl:max-2xl:w-[50%] sm:w-[50%] h-full rounded-md mt-4"/>
         <img src="/images/download3.png" alt="Date Filtering Example" class="w-full xl:max-2xl:w-[50%] sm:w-[50%] h-full rounded-md mt-4"/>
       <span class="font-bold" >Pivot Mode Enable:</span><br/><br/>
        ...
        For example, if activating Pivot Mode and clicking 'Users' in the Graded Wagers report, the report will automatically group by 'Users'.</p>
         <img src="/images/download4.png" alt="Date Filtering Example" class="w-full xl:max-2xl:w-[50%] sm:w-[50%] h-full rounded-md mt-4"/>
...
<br/>
      <img src="/images/download5.png" alt="Date Filtering Example" class="w-full xl:max-2xl:w-[50%] sm:w-[50%] h-full rounded-md mt-4"/></br>
  ...
  <li>Click Search.</li>
       ...
       <img src="/images/download6.png" alt="Date Filtering Example" class="w-full xl:max-2xl:w-[50%] sm:w-[50%] h-full rounded-md mt-4"/>
    ...
    },
    {
      ...
      answer: `
        ...
        <img src="/images/download7.png" alt="Date Filtering Example" class="w-full xl:max-2xl:w-[50%] sm:w-[50%] h-full rounded-md mt-4"/> <br/>
    User can either use the default serach bars or filter by column:<br/><br/>
    <img src="/images/download8.png" alt="Date Filtering Example" class="w-full xl:max-2xl:w-[50%] sm:w-[50%] h-full rounded-md mt-4"/>
    <img src="/images/download9.png" alt="Date Filtering Example" class="w-full xl:max-2xl:w-[50%] sm:w-[50%] h-full rounded-md mt-4"/>
      `,
    },
    {
    ...
    <img src="/images/download10.png" alt="Date Filtering Example" class="w-full xl:max-2xl:w-[50%] sm:w-[50%] h-full rounded-md mt-4"/>`,
    },
    {
      question: "Creating a Bonus: Cash Bonus",
      answer: `
        <span class="font-bold" >1. Select 'Bonuses' from the menu on the left side.</span><br/><br/>
        <img src="/images/download11.png" alt="Date Filtering Example" class="w-full xl:max-2xl:w-[50%] sm:w-[50%] h-full rounded-md mt-4"/><br/>
         <span class="font-bold" >2. Choose the 'Create' tab from the menu in the upper right</span><br/><br/>
        <img src="/images/download12.png" alt="Date Filtering Example" class="w-full xl:max-2xl:w-[50%] sm:w-[50%] h-full rounded-md mt-4"/><br/>
...
<br/>
      ...
      <img src="/images/download13.png" alt="Date Filtering Example" class="w-full xl:max-2xl:w-[50%] sm:w-[50%] h-full rounded-md mt-4"/>
       <img src="/images/download14.png" alt="Date Filtering Example" class="w-full xl:max-2xl:w-[50%] sm:w-[50%] h-full rounded-md mt-4"/>
       <img src="/images/download15.png" alt="Date Filtering Example" class="w-full xl:max-2xl:w-[50%] sm:w-[50%] h-full rounded-md mt-4"/>
    ...
    },
    {
      ...
      answer: `
      <span class="font-bold" >1. Select 'Bonuses' from the menu on the left side</span><br/><br/>
      <img src="/images/download16.png" alt="Date Filtering Example" class="w-full xl:max-2xl:w-[50%] sm:w-[50%] h-full rounded-md mt-4"/><br/>
       <span class="font-bold" >2. Choose the 'Create' tab from the menu in the upper right</span><br/><br/>
      <img src="/images/download17.png" alt="Date Filtering Example" class="w-full xl:max-2xl:w-[50%] sm:w-[50%] h-full rounded-md mt-4"/><br/>
<span class="font-bold" >3. Input the required data accordingly.</span><br/><br/>
<ul style="list-style-type: disc; padding-left: 20px;">
  <li>*Name:<br/>It denotes the internal name you'll assign to the bonus.</li>
  <li>*Agent:<br/>Is the Agent responsible for the group of customers who will receive the Bonus.</li>
...
<br/>
    ...
    <img src="/images/download18.png" alt="Date Filtering Example" class="w-full xl:max-2xl:w-[50%] sm:w-[50%] h-full rounded-md mt-4"/>
     <img src="/images/download19.png" alt="Date Filtering Example" class="w-full xl:max-2xl:w-[50%] sm:w-[50%] h-full rounded-md mt-4"/>
  ...
  `,
    },
    {
      ...
      <img src="/images/download20.png" alt="Date Filtering Example" class="w-full xl:max-2xl:w-[50%] sm:w-[50%] h-full rounded-md mt-4"/><br/>
      ...
      <img src="/images/download21.png" alt="Date Filtering Example" class="w-full xl:max-2xl:w-[50%] sm:w-[50%] h-full rounded-md mt-4"/><br/>
...
<br/>
      <img src="/images/download22.png" alt="Date Filtering Example" class="w-full xl:max-2xl:w-[50%] sm:w-[50%] h-full rounded-md mt-4"/><br/>
          
      <img src="/images/download23.png" alt="Date Filtering Example" class="w-full xl:max-2xl:w-[50%] sm:w-[50%] h-full rounded-md mt-4"/><br/>
          
      <img src="/images/download24.png" alt="Date Filtering Example" class="w-full xl:max-2xl:w-[50%] sm:w-[50%] h-full rounded-md mt-4"/><br/>
...
<img src="/images/download25.png" alt="Date Filtering Example" class="w-full xl:max-2xl:w-[50%] sm:w-[50%] h-full rounded-md mt-4"/><br/>
<br/>
...
<img src="/images/download26.png" alt="Date Filtering Example" class="w-full xl:max-2xl:w-[50%] sm:w-[50%] h-full rounded-md mt-4"/>   <br/>
<span class="font-bold" >Rollover & Applicability</span><br/><br/>
<img src="/images/download27.png" alt="Date Filtering Example" class="w-full xl:max-2xl:w-[50%] sm:w-[50%] h-full rounded-md mt-4"/> 
<img src="/images/download28.png" alt="Date Filtering Example" class="w-full xl:max-2xl:w-[50%] sm:w-[50%] h-full rounded-md mt-4"/>  
      `,
    },
    {
 ...
 <span class="font-bold" > Bonus main setup & Award</span></br>
<img src="/images/download29.png" alt="Date Filtering Example" class="w-full xl:max-2xl:w-[50%] sm:w-[50%] h-full rounded-md mt-4"/>   <br/>
<span class="font-bold" >Rollover & Applicability</span><br/><br/>
<img src="/images/download30.png" alt="Date Filtering Example" class="w-full xl:max-2xl:w-[50%] sm:w-[50%] h-full rounded-md mt-4"/> 
...
<span class="font-bold" > Bonus main setup & Award</span></br>
<img src="/images/download31.png" alt="Date Filtering Example" class="w-full xl:max-2xl:w-[50%] sm:w-[50%] h-full rounded-md mt-4"/>   <br/>
<span class="font-bold" >Rollover & Applicability</span><br/><br/>
<img src="/images/download32.png" alt="Date Filtering Example" class="w-full xl:max-2xl:w-[50%] sm:w-[50%] h-full rounded-md mt-4"/> 
...
<img src="/images/download33.png" alt="Date Filtering Example" class="w-full xl:max-2xl:w-[50%] sm:w-[50%] h-full rounded-md mt-4"/>   <br/>
<span class="font-bold" >Rollover & Applicability</span><br/><br/>
<img src="/images/download34.png" alt="Date Filtering Example" class="w-full xl:max-2xl:w-[50%] sm:w-[50%] h-full rounded-md mt-4"/> 
...
<img src="/images/download35.png" alt="Date Filtering Example" class="w-full xl:max-2xl:w-[50%] sm:w-[50%] h-full rounded-md mt-4"/>   <br/>
<span class="font-bold" >Rollover & Applicability</span><br/><br/>
<img src="/images/download36.png" alt="Date Filtering Example" class="w-full xl:max-2xl:w-[50%] sm:w-[50%] h-full rounded-md mt-4"/> 
...
<img src="/images/download37.png" alt="Date Filtering Example" class="w-full xl:max-2xl:w-[50%] sm:w-[50%] h-full rounded-md mt-4"/>   <br/>
<span class="font-bold" >Rollover & Applicability</span><br/><br/>
<img src="/images/download38.png" alt="Date Filtering Example" class="w-full xl:max-2xl:w-[50%] sm:w-[50%] h-full rounded-md mt-4"/> 
...
<img src="/images/download39.png" alt="Date Filtering Example" class="w-full xl:max-2xl:w-[50%] sm:w-[50%] h-full rounded-md mt-4"/>   <br/>
<span class="font-bold" >Rollover & Applicability</span><br/><br/>
<img src="/images/download40.png" alt="Date Filtering Example" class="w-full xl:max-2xl:w-[50%] sm:w-[50%] h-full rounded-md mt-4"/> 
